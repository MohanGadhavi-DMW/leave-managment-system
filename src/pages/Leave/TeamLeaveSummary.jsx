          ...
          history: [
            {
              ...
              reason:
                "I need to attend a personal family matter and will resume work the next day.",
            },
            {
              id: 202,
              status: "Approved",
              ...
              reason:
                "Taking a casual leave due to personal errands that require my presence.",
            },
          ],
        },
        {
          ...
          history: [
            {
              ...
              reason:
                "I am unwell due to viral fever and require rest as advised by the doctor.",
            },
            {
              id: 302,
              status: "Approved",
              ...
              reason:
                "Experiencing severe migraine and unable to work effectively today.",
            },
          ],
        },
        {
          ...
          history: [
            {
              ...
              reason:
                "Planning a family vacation and will ensure work handover before leaving.",
            },
            {
              id: 402,
              status: "Approved",
              ...
              reason:
                "Applying for planned leave for year-end personal travel.",
            },
            {
              id: 403,
              status: "Approved",
          ...
          history: [
            {
              ...
              reason:
                "Taking bereavement leave due to the loss of a close family member.",
            },
          ],
        },
      ],
          ...
          history: [
            {
              ...
              reason:
                "Applying for paternity leave following the birth of my child.",
            },
          ],
        },
      ],
          ...
          <div className="w-full px-2 max-h-[65vh] overflow-y-auto no-scrollbar pb-4">
            <div className="space-y-4">
              {selectedEmployee.leaveStats.map((stat) => {
                const theme = leaveTypeThemes[stat.type] || {
                  text: "text-gray-700",
                  bg: "bg-gray-50/50",
                };
                return (
                            ...
                            >
                              ...
                              {entry.reason && (
                                <div className="flex gap-2 text-left">
                                  <span className="text-gray-700 font-semibold text-sm flex-shrink-0">
                                    Reason:
                                  </span>
